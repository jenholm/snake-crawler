...
**Aggregated, scored, and filtered by AI prioritized for you, by Enholm Heuristics.**
...
-   **🧠 Agentic AI Personalization**:
    -   **Two-Stage Triage**: Instant metadata screening to filter junk/low-quality content.
    -   **Deep Scoring**: Rubric-based evaluation of full-text "Content Cards" (Claims, Entities, Summaries).
    -   **Adaptive Discovery**: AI-driven "Next-link" planning to find high-signal articles within your feed sources.
    -   **Active Learning**: Intelligent micro-questions to refine your interest profile in real-time.
    -   **Source Reputation**: Automatic trust scoring for sources based on historical article pass rates.
...
-   **Semantic Deduplication**: Automatically clusters similar stories to reduce feed clutter.
...
3.  **Set up your environment variables:**
    ...
    ```bash
    cp .env.example .env # If an example exists, or manually:
